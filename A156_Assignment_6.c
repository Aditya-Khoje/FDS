...
int postfix_evaluation_function(char postfix[20])
{
    STACK *top = NULL;
    int i = 0;
    char token, x;
...
int prefix_evaluation_function(char prefix[20])
{
    char prefix_rev[20];
...
int main()
{
    ...
    do
    {
        ...
        case 3:
            ...
            scanf("%s", postfix);
            printf("\nans=  %d  ", postfix_evaluation_function(postfix));
            break;

        case 4:
            printf("\nEnter prefix expression : ");
            scanf("%s", prefix);
            printf("ans=  %d  ", prefix_evaluation_function(prefix));
            break;
